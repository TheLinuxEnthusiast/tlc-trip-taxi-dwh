...
with DAG(
    ...
    fhvhv_data_quality_check = StagingDataQuality(
        task_id="fhvhv_data_quality_check",
        table="fhvhv_staging"
    )
    
    clean_staging_data = CleanStagingData(
        task_id="clean_staging_data_fhvhv",
        table="fhvhv_staging",
        schema="public"
    )
    ...
    [load_taxi_base_data, load_taxi_zone_data, load_dependencies] >> load_fhvhv_staging_table
    load_fhvhv_staging_table >> fhvhv_data_quality_check
    fhvhv_data_quality_check >> clean_staging_data
